-- Create UserProjectFolders Table
-- Run this SQL script directly in SQL Server Management Studio or your SQL client
-- This will create the UserProjectFolders table immediately
